...
export default function HeroSection({ listings }: HeroSectionProps) {
  return (
    <section
      aria-label="Hero"
      className="relative min-h-[70vh] flex flex-col justify-center bg-gradient-to-br from-black via-zinc-900 to-black text-white px-6 py-20 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center text-center">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight mb-4">
          Find Your Next Car. <span className="text-yellow-400">No Surprises.</span>
        </h1>
